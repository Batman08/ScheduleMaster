...
var connectionString = builder.Configuration.GetConnectionString("DatabaseConnStr") ?? throw new InvalidOperationException("Connection string 'DefaultConnection' not found.");
